...
<div class="spwidgets-demo-cntr">
    ...
    <div>
        <span>Build: </span><span>20140314040043</span>
    </div>
    <div>
...
(function(h){var s=h;document.head||(document.head=document.getElementsByTagName("head")[0]);(function(){try{h.pt||(h.pt={})}catch(c){h.pt={}}void 0===h.pt._cache&&(h.pt._cache={});h.SPWidgets={};h.SPWidgets.version="20140314040043";h.SPWidgets.defaults={};h.fn.SPMsgHasError=function(){var c=h(this).find("ErrorCode"),e=!1;if(!c.length)return h(this).find("faultcode").length?!0:!1;c.each(function(){if("0x00000000"!==h(this).text())return e=!0,!1});return e};h.fn.SPGetMsgError=function(){var c=
...
m.find("CHOICES CHOICE").each(function(a,d){var b=c(this).text();if(!f.fieldFilter||c.grep(f.fieldFilter,function(a){return a===b}).length){if(a>=k.maxColumns){try{console.log("SPWIDGETS:BOARD:Warning: Can only build a max of "+k.maxColumns+" columns!")}catch(e){}return!1}f.states.push({type:"choice",title:b,name:b});f.statesMap[b]=f.states[f.states.length-1]}});a.resolveWith(f,[b,e]);break;case "lookup":f.fieldFilter||(f.fieldFilter="<Query></Query>");c().SPServices({operation:"GetListItems",listName:m.attr("List"),
async:!0,cacheXML:!0,CAMLQuery:f.fieldFilter,webURL:f.webURL,CAMLRowLimit:k.maxColumns,CAMLViewFields:'<ViewFields><FieldRef Name="'+m.attr("ShowField")+'" /></ViewFields>',completefunc:function(b,e){if("error"===e)a.rejectWith(d,["Communications Error!",b,e]);else{var g=c(b.responseXML);g.SPMsgHasError()?a.rejectWith(d,[g.SPGetMsgError(),b,e]):(f.isStateRequired||(f.states.push({type:"lookup",title:f.optionalLabel,name:""}),f.statesMap[""]=f.states[f.states.length-1]),g.SPFilterNode("z:row").each(function(a,
b){if(a>=k.maxColumns){try{console.log("SPWIDGETS:BOARD:Warning: Can only build a max of "+k.maxColumns+" columns!")}catch(d){}return!1}var e=c(this),g=e.attr("ows_ID"),e=e.attr("ows_"+m.attr("ShowField")),g=g+";#"+e;f.states.push({type:"lookup",title:e,name:g});f.statesMap[g]=f.states[f.states.length-1]}),a.resolveWith(f,[b,e]))}}});break;default:a.rejectWith(d,["Field ("+f.field+") Type ("+m.attr("Type")+") is not supported!",b,e])}}})}).promise()},_getListItems:function(){return c.Deferred(function(a){function b(e){c.isFunction(f.onGetListItems)&&
f.onGetListItems.call(d,f.listItems,e);a.resolveWith(d,[f.listItems])}c.isFunction(f.CAMLQuery)?f.CAMLQuery.call(d,function(a){c.isArray(a)&&(f.listItems=a,b(f.CAMLQuery))},e):c().SPServices({operation:"GetListItems",listName:f.list,async:!0,CAMLQuery:f.CAMLQuery,CAMLRowLimit:0,CAMLViewFields:f.CAMLViewFields,webURL:f.webURL,completefunc:function(e,g){if("error"===g)a.rejectWith(d,["Communications Error!",e,g]);else{var m=c(e.responseXML);m.SPMsgHasError()?a.rejectWith(d,[m.SPGetMsgError(),e,g]):
(f.listItems=m.SPFilterNode("z:row").SPXmlToJson({includeAllAttrs:!0}),b(m))}}})}).promise()},getBoardItemDataObject:function(a){var b=null,d,e,g;if(a)for(a=String(a),d=0,e=f.listItems.length;d<e;d++)g=f.listItems[d].ID,c.isFunction(g)&&(g=f.listItems[d].ID()),g=String(g),a===g&&(b=f.listItems[d],d=e+e);return b},showItemsOnBoard:function(a){function b(a,g){var m="",l=null,q="";c.isFunction(f.template)?(m=f.template.call(d,a,g))&&(m=String(m)):m=c.SPWidgets.fillTemplate(f.template,t);void 0!==g&&
...
a);f.showNumberOfColumns&&b.removeClass("spwidget-states-"+f.showNumberOfColumns);f.showNumberOfColumns=a;return f},setupColumnPicker:function(){var a=d.find(".spwidget-board-column-list-cntr"),b=a.find("div.spwidget-board-column-list"),e=a.children("div.ui-state-default:last"),g={$totalCntr:a.find("span.spwidget-board-column-total"),setTotalSelected:function(){var a=g.getSelected().length;g.$totalCntr.html(a);return a},getSelected:function(){return b.find("a.ui-state-highlight")},showMessage:function(a){c('<div class="spwidget-board-msg ui-state-error ui-corner-all">'+
a+"</div>").appendTo(e).fadeOut(8E3,function(){c(this).remove()})},setSelected:function(){var a=b.find("a");c.each(f.states,function(c,b){var f=a.filter("[data-board_col_index='"+c+"']");b.isVisible?g.selectColumn(f,!1):g.selectColumn(f,!0)});g.setTotalSelected()},selectColumn:function(a,b){c(a).each(function(){var a=c(this),f=a.find(".ui-icon");a.hasClass("ui-state-highlight")||b?!1!==b&&(f.removeClass("ui-icon-check"),a.removeClass("ui-state-highlight")):(f.addClass("ui-icon-check"),a.addClass("ui-state-highlight"))});
return a},setVisibleColumns:function(a){a||(a=g.getSelected());var b=a.length;c.each(f.states,function(c,b){a.filter("[data-board_col_index='"+c+"']").length?!1===b.isVisible&&(b.isVisible=!0,b.dataEle.css("display",""),b.headerEle.css("display","")):(b.isVisible=!1,b.dataEle.css("display","none"),b.headerEle.css("display","none"))});f.setBoardColumnClass(b);f.setBoardColumnHeight()}};g.setUserDefinedVisibleCol=f.setUserDefinedVisibleCol=function(a){var d=0,e="";if(!c.isArray(a)||!a.length){if(!c.isArray(a)&&
"all"!==String(a).toLowerCase())return;a=[];c.each(f.states,function(c,b){a.push(b.title)})}c.each(a,function(a,b){c.each(f.states,function(a,c){if(c.title===b)return d++,1<d&&(e+=","),e+="a[data-board_col_name='"+c.name+"']",!1});if(d>=f.maxColumnVisible)return!1});2<=d&&(g.setVisibleColumns(b.find(e)),g.triggerEvent())};g.triggerEvent=function(){var a=[];f.initDone&&(c.each(f.statesMap,function(c,b){b.isVisible&&a.push(b.title)}),f.ele.trigger("spwidget:boardColumnChange",[f.ele,a]))};a.find("button[name='apply']").button({label:f.colPickerApplyLabel,
icons:{secondary:"ui-icon-circle-check"}}).on("click",function(c){c=g.getSelected();var b=c.length;b>f.maxColumnVisible?g.showMessage(f.colPickerMaxColMsg):2>b?g.showMessage(f.colPickerMinColMsg):(a.hide(),g.setVisibleColumns(c),g.triggerEvent())});a.find("button[name='check']").attr("title",f.colPickerCheckLabel).button({text:!1,icons:{primary:"ui-icon-radio-off"}}).on("click",function(a){a=g.getSelected();a.length?g.selectColumn(a,!0):g.selectColumn(b.find("a"));g.setTotalSelected()});a.find("button[name='close']").attr("title",
...
c.SPWidgets.makeSameHeight(f.statesCntr.find("div.spwidget-board-state:visible"),20,"min-height");f.headersCntr.is(":visible")&&c.SPWidgets.makeSameHeight(f.headersCntr.find("div.spwidget-board-state:visible"),0,"min-height")}});if(!f.list||!f.field)return d.html("<div>SPWidgets:Board [ERROR] Missing required input parameters!</div>"),this;d.addClass("loadingSPShowBoard").data("SPShowBoardOptions",f);f.getBoardStates().then(function(){""===f.CAMLViewFields?f.CAMLViewFields='<ViewFields><FieldRef Name="ID" /><FieldRef Name="Title" /><FieldRef Name="'+
f.field+'" /></ViewFields>':0>f.CAMLViewFields.indexOf(f.field)&&(f.CAMLViewFields=f.CAMLViewFields.replace(/\<\/ViewFields\>/i,'<FieldRef Name="'+f.field+'" /></ViewFields>'));d.html(c(k.htmlTemplate).filter("div.spwidget-board"));f.tmpltHeader=c("<div/>").append(d.find("div.spwidget-board-headers-cntr div.spwidget-board-state").clone()).html();f.tmpltState=c("<div/>").append(d.find("div.spwidget-board-states-cntr div.spwidget-board-state")).html();f.states.length<=f.maxColumnVisible&&(f.showNumberOfColumns=
f.states.length);f.statesCntr=d.find("div.spwidget-board-states-cntr").addClass("spwidget-states-"+f.showNumberOfColumns).empty();f.headersCntr=d.find("div.spwidget-board-headers-cntr").addClass("spwidget-states-"+f.showNumberOfColumns).empty();c.each(f.states,function(a,b){b.headerEle=c(f.tmpltHeader).appendTo(f.headersCntr).attr("data-boardstate",b.name).attr("data-boardindex",a).html("<span>"+b.title+"</span>");b.dataEle=c(f.tmpltState).appendTo(f.statesCntr).attr("data-boardindex",a).attr("data-boardstate",
b.name);b.headerTotalEle=c('<span class="spwidget-stat-item-stat-cntr">&nbsp;<span class="spwidget-stat-item-stat ui-widget-content ui-corner-all spwidget-state-item-total">0</span></span>').appendTo(b.headerEle).find("span.spwidget-state-item-total");b.isVisible=!0;a>f.maxColumnVisible-1&&(b.headerEle.css("display","none"),b.dataEle.css("display","none"),b.isVisible=!1)});c(f.headersCntr,f.statesCntr).append('<div style="clear:both;"></div>');!0===f.showColPicker&&f.setupColumnPicker();d.on("sortreceive sortremove",
function(a,b){f.updBoardHeaders();c(b.item).removeClass("ui-state-hover")}).on("sortreceive",function(a,b){var e=f.getEventObject(b.item),g=c.Deferred(),m="",m=c.isFunction(e.itemObj.ID)?e.itemObj.ID():e.itemObj.ID;e.updates=[];e.updatePromise=g.promise();e.updates.push([f.field,e.currentState]);if(c.isFunction(f.onPreUpdate)&&!0===f.onPreUpdate.call(b.item,a,b.item,e)||!e.updates.length)return this;c().SPServices({operation:"UpdateListItems",listName:f.list,async:!0,ID:m,valuepairs:e.updates,webURL:f.webURL,
completefunc:function(f,m){if("error"===m)g.rejectWith(d,["Communications Error!",f,m]);else{var k=c(f.responseXML),n=null;k.SPMsgHasError()?g.rejectWith(d,[k.SPGetMsgError(),f,m]):(n=c(f.responseXML).SPFilterNode("z:row").SPXmlToJson({includeAllAttrs:!0}),c(a.target).trigger("spwidget:boardchange",[b.item,e]),g.resolveWith(a.target,[n[0],e.itemObj,f]))}}})}).on("click","a.spwidgets-board-action",function(a){a=c(a.currentTarget);var b=String(a.data("spwidgets_board_action")).toLowerCase(),d="",e=
c.pt.getEscapedUrl(window.location.href);switch(b){case "edit-item":d=f.getListFormUrl("EditForm");break;case "view-item":d=f.getListFormUrl("DisplayForm")}window.location.href=d+"?ID="+a.data("spwidgets_id")+"&Source="+e;return this});null===f.template&&(f.template=c(k.htmlTemplate).filter("div.spwidget-item-template"));f._getListItems().then(function(){f.showItemsOnBoard();f.statesCntr.find("div.spwidget-board-state").each(function(){var a=c(this);a.sortable({connectWith:a.siblings(),containment:d,
cursor:"move",tolerance:"pointer",opacity:".80",placeholder:"ui-state-highlight spwidget-board-placeholder",forcePlaceholderSize:!0,remove:function(a,c){f.setBoardColumnHeight()}})});f.statesCntr.disableSelection();f.initDone=!0;f.setBoardColumnHeight();d.addClass("hasSPShowBoard").removeClass("loadingSPShowBoard");c.isFunction(f.onBoardCreate)&&f.onBoardCreate.call(d,f.getEventObject());c(d).trigger("spwidget:boardcreate",[d,f.getEventObject()])})}).fail(function(a,c,b){d.append('<div class="ui-state-error"><p>'+
...
"clear"===d?(c.isArray(g)||(g=g?[g]:[]),g.length?function(){var b=c();c.each(g,function(c,f){b=b.add(a._selectedItemsCntr.find("div.spwidgets-item-id-"+f))});k.removeItem(a,b)}():k.removeItem(a,a._selectedItemsCntr.find("div.spwidgets-item"))):"add"===d&&k.addItem(a,g)}}return this}a=c.extend({},c.SPWidgets.defaults.LookupField,e,{_ele:d.css("display","none").addClass("hasLookupSPField")});a.showSelectedItems=function(b,f){var d=a._selectedItemsCntr.css("display",""),e=[],g=!1;d.find("div.spwidgets-item").length&&
!1!==a.allowMultiples||d.empty();c.isArray(b)?e=b:e.push(b);c.each(e,function(b,e){if(!d.find("div.spwidgets-item-id-"+e.ID).length){var m=c('<div class="spwidgets-item spwidgets-item-id-'+e.ID+'" data-spid="'+e.ID+'" style="display:none">'+c.SPWidgets.fillTemplate(a.template,e)+"</div>").appendTo(d).find(".spwidgets-item-remove").on("click.SPWidgets",function(c){k.removeItem(a,this)}).end();c.isFunction(a.onItemAdd)&&!0!==f&&a.onItemAdd.call(a._ele,m,e,a._cntr);0<d.find("div.spwidgets-item-id-"+
e.ID).length&&(g=!0,m.fadeIn("slow").promise().then(function(){c(this).css("display","")}),!0!==f&&a.storeItemIDs(e.ID,a.allowMultiples),!1===a.allowMultiples&&!0===a.hideInput&&a._lookupInputEleCntr.css("display","none"))}});a.readOnly&&a._cntr.find(".spwidgets-item-remove").remove();g&&a._ele.trigger("change")};a.storeItemIDs=function(b,f){var d=c.trim(a._ele.val()),e=!1;c.isArray(b)||(b=[b]);!0!==f&&(d="");c.each(b,function(c,b){b&&(1>d.length&&(!0===a.padDelimeter&&!e)&&(d+=";#",e=!0),0<d.length&&
(d+=";#"),d+=b+";#")});a._ele.val(d)};a.showCurrentInputSelection=function(b){return c.Deferred(function(f){var d=c.extend({},{async:!0},b),e=c.SPWidgets.parseLookupFieldValue(a._ele.val());e.length?c().SPServices({operation:"GetListItems",async:d.async,listName:a.list,CAMLQuery:"<Query><Where>"+c.SPWidgets.getCamlLogical({type:"OR",values:e,onEachValue:function(a){var c="";a.id&&(c="<Eq><FieldRef Name='ID'/><Value Type='Counter'>"+a.id+"</Value></Eq>");return c}})+"</Where></Query>",CAMLViewFields:"<ViewFields>"+
...
"")});var f=a._autocompleteCache={};a._cntr.find("div.spwidgets-lookup-input input").autocomplete({minLength:2,appendTo:a._cntr,open:function(b,f){c(this).autocomplete("widget").each(function(){0<a.listHeight&&c(this).css("height",a.listHeight+"px");return!1})},source:function(b,d){b.term=c.trim(b.term);var e=String(c.trim(b.term)).toUpperCase();if(e in f)d(f[e]);else{f[e]=[];var g=[],k=String(b.term);if(null===k.match(/\D/)&&null!==k.match(/\d/))g.push("<Eq><FieldRef Name='ID'/><Value Type='Counter'>"+
k+"</Value></Eq>");else{k=[b.term];a.exactMatch||(k=String(b.term).split(/ /));for(var h=0,u=a.filterFields.length;h<u;h++){for(var v=[],w=0,z=k.length;w<z;w++)a._ignoreKeywordsRegEx.test(k[w])||v.push("<Contains><FieldRef Name='"+a.filterFields[h]+"'/><Value Type='Text'>"+k[w]+"</Value></Contains>");g.push(c.SPWidgets.getCamlLogical({values:v,type:"AND"}))}}g=c.SPWidgets.getCamlLogical({values:g,type:"OR"});a.filter&&(g=c.SPWidgets.getCamlLogical({values:[g,a.filter],type:"AND"}));c().SPServices({operation:"GetListItems",
listName:a.list,async:!0,CAMLQuery:"<Query><Where>"+g+"</Where>"+a.filterOrderBy+"</Query>",CAMLRowLimit:a.maxResults,CAMLViewFields:"<ViewFields>"+a._selectFields+"</ViewFields>",completefunc:function(b,g){c(b.responseXML).SPFilterNode("z:row").each(function(){var b=c(this).SPXmlToJson({includeAllAttrs:!0})[0];b.value="";b.label=c.SPWidgets.fillTemplate(a.listTemplate,b);f[e].push(b)});d(f[e])}})}},select:function(b,c){a.showSelectedItems(c.item)}}).on("keyup.SPWidgets",function(b){if(13==b.which){var f=
...
d.addPeopleToList=function(a,b){var c=(new String(a)).split(";#"),e=c.length,g,k,r;for(g=0;g<e;g++)k=c[g],g++,r=c[g],k=h.pt.pickSPUser.getUserHtmlElement(d,k,r).appendTo(d.eleSelected),function(a,b){d.getSearchResults(b).done(function(c,f,d){var e=String(b).toLowerCase();h.each(c,function(b,c){if(String(c.displayName).toLowerCase()===e)return a.data("pickspuser_object",c),!1})})}(k,r);h.pt.addHoverEffect(d.eleSelected.find("div.pt-pickSPUser-person-cntr"));!1===d.allowMultiples&&d.elePickInput.css("display",
"none");h.pt.pickSPUser.storeListOfUsers(d.eleSelected,b)};d.getSearchResults=function(a){return h.Deferred(function(b){h().SPServices({operation:"SearchPrincipals",searchText:a,maxResults:d.maxSearchResults,principalType:d.type,async:!0,webURL:d.webURL,completefunc:function(a,c){var f=[];h(a.responseXML).find("PrincipalInfo").each(function(){var a=h(this),a={displayName:a.find("DisplayName").text(),accountId:a.find("UserInfoID").text(),accountName:a.find("AccountName").text(),accountType:a.find("PrincipalType").text(),
value:a.find("DisplayName").text(),label:""};a.label+=a.displayName;f.push(a)});b.resolveWith(a,[f,a,c])}})}).promise()};!0===d.allowMultiples&&d.eleSelected.addClass("pt-pickSPUser-selected-multiple");var e={};d.elePickInput.find("input[name='pickSPUserInputField']").attr("placeholder",d.inputPlaceholder).autocomplete({minLength:3,appendTo:d.elePickInput,source:function(a,b){a.term in e?b(e[a.term]):(e[a.term]=[],d.getSearchResults(a.term).then(function(c,d,k){e[a.term].push.apply(e[a.term],c);b(e[a.term])}))},
select:function(c,e){if(!1===d.allowMultiples)d.eleSelected.empty();else if(d.eleSelected.find("div[data-pickspuserid='"+e.item.accountId+"']").length)return;h.pt.pickSPUser.getUserHtmlElement(d,e.item.accountId,e.item.displayName).appendTo(d.eleSelected).data("pickspuser_object",e.item);h.pt.pickSPUser.storeListOfUsers(a);h.pt.addHoverEffect(a.find("div.pt-pickSPUser-person-cntr"));setTimeout(function(){c.target.value=""},50);!1===d.allowMultiples&&d.elePickInput.hide();h.isFunction(d.onPickUser)&&
d.onPickUser.call(d.eleUserInput,h.extend({},e.item));b.trigger(h.Event("spwidget:peoplePickerAdd"),[d.eleUserInput,h.extend({},e.item)])}});a.data("pickSPUserContainerOpt",d);b.data("pickSPUserContainer",a);b.val()&&d.addPeopleToList(b.val(),!0);h.isFunction(d.onCreate)&&d.onCreate.call(b,b);b.trigger(h.Event("spwidget:peoplePickerCreate"),[d.eleUserInput]);return this});return this};h.pt.pickSPUser.getUserHtmlElement=function(c,k,e){c=h(h.pt.pickSPUser.htmlTemplate).find(".pt-pickSPUser-person").clone(1);
...
completefunc:function(b,f){var d=c(b.responseXML).SPFilterNode("z:row").SPXmlToJson({includeAllAttrs:!0});d.length&&(a=d[0])}});return a};b.isUploadPage=function(a){var c=!1,d=document.createElement("a"),e=null;d.href=String(a).toLowerCase();b.userUploadPage?(e=document.createElement("a"),e.href=String(b.userUploadPage).toLowerCase(),d.pathname===e.pathname&&(c=!0)):c=/upload(ex)?\.aspx$/.test(d.pathname);return c};b.listName&&0!==b.listName.indexOf("{")&&(b.listName=c.pt.getListUID(b.listName));
...
if(a.is(":visible"))return b.find(".loadingOverlay").css("display","none").end(),!1})}else g.showError({message:g.noFileErrorMessage})};k.onIframeChange=function(e){var b=c(e).closest(".SPControlUploadUI"),d=b.data("SPControlUploadOptions"),a=0;try{d.log("Upload.onIframeChange(): Document readyState: "+b.find("iframe").contents()[0].readyState)}catch(g){}2===d.ev.state&&"preLoad"===d.ev.action?(d.log("Upload.onIframeChange("+d._iframeLoadId+"): ev.action=["+d.ev.action+"] and ev.state=["+d.ev.state+
"] - handled by onUpload(). Setting action to postLoad"),d.ev.action="postLoad"):(d._iframeLoadId++,a=d._iframeLoadId,d.log("Upload.onIframeChange("+a+"): State=["+d.ev.state+"] Action=["+d.ev.action+"] iframe.url: "+b.find("iframe").contents()[0].location.href),setTimeout(function(){if(a!==d._iframeLoadId)d.log("Upload.onIframeChange("+a+"): not latest invokation! Existing.");else{d.log("Upload.onIframeChange("+a+"): START... Executing setTimeout() for iframe ID: "+a);var f=c(b.find("iframe").contents()),
e=d.ev,g=f.find("form").eq(0);e.pageUrl=f[0].location.href;e.page=f;d.$iframeCntr.scrollTop(0);f.scrollTop(0);if(d.isUploadPage(e.pageUrl)){d.log("Upload.onIframeChange("+a+"): URL is the upload page!");f.find("body").css({overflow:"hidden"});g.children(":visible").hide().end().append(c(k.HtmlUI).filter("div#SPControlUploadModUI").clone()).find("div.SPControlUploadModUIFileSelected").html(d.selectFileMessage);if(RegExp(/error/i).test(c.trim(f.find(".ms-pagetitle").text()))||RegExp(/error/i).test(c.trim(f.find("title").text()))||
RegExp(/error\.aspx/i).test(c.trim(f.find("form").attr("action")))){d.log("Upload.onIframeChange("+a+"): page displaying an error... Storing it and reloading upload form.");d._lastError=f.find("[id$='LabelMessage']").text();if(1<d._reloadCount){alert("Error encountered during upload which is causing program to loop. Last upload error was: "+d._lastError);b.find(".loadingOverlay").fadeOut();return}d._reloadCount+=1;b.find("iframe").attr("src",d.uploadPage);return}if(f.find("#GearPage")&&!f.find("input[type='file']").length){d.log("Upload.onIframeChange("+
a+"): SP processing page (GearPage)... Exiting and waiting for next page...");return}f.find("input[type='file']").closest("table").appendTo(f.find("#SPControlUploadModUI")).removeClass("ms-authoringcontrols");var h=f.find("#SPControlUploadModUI").find("input[type='file']").closest("tr").siblings().css("display","none").end().end().siblings("tr .ms-error").css("display","").end().on("change focus click",function(a){a=c(this).val();var b="",e="/_layouts/images/urn-content-classes-smartfolder16.gif";
if(a){try{b=a.substr(a.lastIndexOf(".")+1)}catch(g){b="GEN"}e="/_layouts/images/IC"+b.toUpperCase()+".GIF";a=a.replace(/\\/g,"/").split("/").pop()||a}else a=d.selectFileMessage;f.find("#SPControlUploadModUI > div").html(a).css("background-image","url('"+e+"')")}).css({cursor:"pointer",height:"100px",position:"absolute",left:"0px",top:"0px",filter:"alpha(opacity=1)",opacity:"0.01",outline:"none","-moz-opacity":"0.01","font-size":"100px","z-index":"5"});g.on("mousemove",function(a){h.css({left:a.pageX-
(h.width()-50),top:a.pageY-30}).blur()});d._lastError&&(d.showError({message:d._lastError}),d._lastError="");d._reloadCount=0;d.overwrite?f.find("input[type='checkbox'][name$='OverwriteSingle']").prop("checked","checked"):f.find("input[type='checkbox'][name$='OverwriteSingle']").prop("checked","");e.state=1;e.action="postLoad";e.hideOverlay=!0}else{d.log("Upload.onIframeChange("+d._iframeLoadId+"): File uploaded to server! Need ["+d.uploadDonePage+"] to be done.");e.state=3;e.action="postLoad";e.hideOverlay=
!0;e.file=d.getUploadedFileRow();if(k.isSameUrlPage(e.pageUrl,d.uploadDonePage))d.log("Upload.onIframeChange("+d._iframeLoadId+"): Upload widget process DONE!"),e.isUploadDone=!0,e.hideOverlay=!1,d.showHideBusy(),d.showHideSuccess();else if(d.log("Upload.onIframeChange("+d._iframeLoadId+"): Post Upload Form being displayed! Hooking into form.onsubmit!"),g.length){var l=g.prop("onsubmit"),y=g.find(d.filenameInputSelector).eq(0);y.length&&(g.children(":visible").css("display","none").addClass("ptWasVisible"),
y.closest("div[id^='WebPart']").appendTo(g).css("display","").removeClass("ptWasVisible"));g[0].onsubmit=function(){d.log("Upload.onIframeChange("+a+"): iframe form.onsubmit triggered!");d.showHideBusy();var b=!0;c.isFunction(d.onPageChange)&&(b=d.onPageChange.call(d.$ele,c.extend({},e,{state:3,action:"preLoad"})));if(!1===b)return d.showHideBusy(!0),b;c.isFunction(l)&&(b=l());if(!1===b)return d.showHideBusy(!0),b;d.showHideFullForm(!0);return b}}c(b.find("iframe")[0].contentWindow).unload(function(a){d.log("Upload.onIframeChange("+
d._iframeLoadId+"): iframe.unload() triggered!");d.showHideBusy();d.showHideFullForm(!0);if(c.isFunction(d.onPageChange))return d.onPageChange.call(d.$ele,c.extend({},e,{state:3,action:"preLoad"}))})}d.log("Upload.onIframeChange("+d._iframeLoadId+"): iframe page setup done!");d.onPageChange&&d.onPageChange.call(d.$ele,e);if("postload"!==e.action.toLowerCase()||!0===e.hideOverlay)d.showHideBusy(!0),!1===e.isUploadDone&&3===e.state&&d.showHideFullForm();e.isUploadDone&&(d.resetWidget(),d.$successCntr.animate({opacity:1},
3E3,function(){d.showHideSuccess(!0)}),c.isFunction(d.onUploadDone)&&d.onUploadDone.call(d.$ele,e.file))}},500))};k.isSameUrlPage=function(c,b){if(!c||!b)return!1;var d=function(a){var b=document.createElement("a");b.href=a;return unescape(b.pathname)},a=String(d(c)).toLowerCase(),d=String(d(b)).toLowerCase();return a===d};c.pt.getEscapedUrl=escapeProperly;c.pt.getUnEscapedUrl=unescapeProperly;c.pt.getListUID=function(e){if(!e)return"";var b="";if(c.pt._cache["getListUID:"+e])return b=c.pt._cache["getListUID:"+
e];c().SPServices({operation:"GetList",listName:e,async:!1,completefunc:function(d,a){b=c(d.responseXML).find("List").attr("ID")}});b&&(c.pt._cache["getListUID:"+e]=b);return b};k.log=function(){var e,b,d=1,a=0,g=!1,f=!1,k=["#FFFFFF","#F5F5F2"];"undefined"===typeof console||"undefined"===typeof console.debug?e=function(){var c,f,e="";c=0;for(f=arguments.length;c<f;c++)e+='<div style="padding: .1em .1em;background-color:'+k[a]+'"><span>['+d+"] </span>"+arguments[c]+"</div>",d++,a=1===a?0:1;e&&(b.append(e),
b.dialog("isOpen")||b.dialog("open"))}:g=!0;return function(){f||(f=!0,g||(b=c("<div><h2>SPWidgets Debug Output</h2></div>").appendTo("body").dialog({title:"Debug output",height:300})));if(g){var a,d;a=0;for(d=arguments.length;a<d;a++)console.debug(arguments[a])}else e.apply(this,arguments)}}();k.StyleSheet="/**\n * FILE: jquery.SPControlUpload.css\n * \n * \n */\n.spcontrolupload .mainContainer {\n\tposition: relative;\n\tdisplay:block;\n\theight: 4em;\n}\n\n.spcontrolupload .iFrameWindow,\n.spcontrolupload .buttonPane,\n.spcontrolupload .spwidget-success-cntr,\n.spcontrolupload .loadingOverlay {\n    position: absolute;\n    top: 0px;\n    height: 3em;\n    width: 100%;\n}\n.spcontrolupload .buttonPane {\n    left: 0px;\n    width: 10%;\n    overflow: hidden;\n    cursor: pointer;\n}\n.spcontrolupload .buttonPane .upload_button {\n    font-weight: bold;\n    font-size: 1.1em;\n    text-align: center;\n    margin-top: .8em;\n}\n\n.spcontrolupload .iFrameWindow {\n    width: 90%;\n    left: 10%;\n    overflow: hidden;\n}\n.spcontrolupload .iFrameWindow iframe {\n\toverflow: auto;\n\twidth: 100%;\n\theight: 99%;\n}\n\n.spcontrolupload .spwidget-show-full-form .iFrameWindow {\n    overflow: auto;\n    width: 100%;\n    margin: 0em;\n    left: 0px;\n    right: auto;\n    z-index: 5;\n}\n\n.spcontrolupload .loadingOverlayMsg {\n\tfont-size: 1em;\n\tbackground-position: left top;\n    background-repeat: no-repeat;\n    background-image: url('/_layouts/images/loadingcirclests16.gif');\n    margin: 0.5em;\n    padding-left: 25px;\n}\n\n.spcontrolupload .spwidget-success-cntr,\n.spcontrolupload .spwidget-error-cntr {\n    display: none;\n}\n.spcontrolupload div.spwidget-msg-cntr {\n    margin: 0.5em .5em .5em 3em;\n\tfont-size: 1em;\n\tbackground-position: left top;\n    background-repeat: no-repeat;    \n}\n.spcontrolupload .spwidget-close {\n    color: red;\n    font-size: xx-small;\n    font-weight: bold;\n    vertical-align: super;\n    cursor: pointer;\n}\n\n.spcontrolupload .spwidget-success-cntr div.spwidget-msg-cntr {\n    background-image: url('/_layouts/images/STS_ListItem_43216.gif');\n    padding-left: 30px;\n}\n\n.spcontrolupload .spwidget-error-cntr {\n    bottom: -1.5em;\n    left: 0px;\n    width: 100%;\n    position: absolute;\n}\n\n.spcontrolupload-dev-mode .iFrameWindow {\n    overflow: auto !important;\n    height: auto !important;\n}\n\n\n";
...
c.fn.SPDateField=function(e){var b=arguments,d=this;k.isInitDone||(k.isInitDone=!0,""!==k.styleSheet&&c('<style type="text/css">\n\n'+k.styleSheet+"\n\n</style>").prependTo("head"),c("body").on("click"+k.evNamespace,k.onPageClick));return"string"===typeof e?function(){var a=String(b[0]).toLowerCase(),e=d;c(d).each(function(f,k){if(c(d).hasClass("hasSPDateField")){var h=c(k),q=h.data("SPDateFieldInstance");if(q&&0<h.length)switch(a){case "getdate":e=q.getDate();break;case "setdate":b[1]&&q.setDate({date:b[1],
format:b[2]||q.opt.datepicker.dateFormat});break;case "removedate":b[1]&&q.removeDate({date:b[1],format:b[2]||q.opt.datepicker.dateFormat});break;case "reset":q.reset();break;case "destroy":q.destroy()}}});return e}():this.each(function(){var a={$ele:c(this).addClass("hasSPDateField"),isInline:!1,inlineCntr:null};if(!a.$ele.is("input[type='text']")){if(a.$ele.is(":input"))return;a.isInline=!0;a.inlineCntr=c(this);a.$ele=c('<input name="spdatefieldinline" value="" type="text" style="display:none" />')}a.opt=
