...
import Promise from "common-micro-libs/src/jsutils/es6-promise";
            ...
            return new Promise(function(resolve, reject){
                ...
                resolveUpdateListItems = function(){
                    ...
                    processAjaxResponses = function(apiResponses, isHttpError){
                         ...
                         *  The response returns from the API call. If batching is turned
    ...
    getUpdateArray = function(options){
        ...
        // the array
        ...
        } else if (Array.isArray(options.updates) && options.updates.length) {
            ...
            // Array<Array>
            } else if (Array.isArray(options.updates[0])) {
