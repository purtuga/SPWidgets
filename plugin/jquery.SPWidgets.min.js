(function(d){try{if(!d.pt)d.pt={}}catch(B){d.pt={}}if(d.pt._cache===undefined)d.pt._cache={};d.SPWidgets={};d.SPWidgets.version="20130509065100";d.SPWidgets.defaults={};d.fn.SPMsgHasError=function(){var a=d(this).find("ErrorCode"),c=false;if(!a.length)return d(this).find("faultcode").length?true:false;a.each(function(){if(d(this).text()!=="0x00000000"){c=true;return false}});return c};d.fn.SPGetMsgError=function(){var a=d(this),c="ERROR: Call to Sharepoint Web Services failed.";if(a.find("ErrorCode").length)c+=
